<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link href="<?= base_url() ?>/vendors/datatables.net/css/jquery.dataTables.min.css">
    <!-- Font Awesome -->
    ...
    <!-- Ion.RangeSlider -->
    <link href="<?= base_url() ?>/vendors/normalize-css/normalize.css" rel="stylesheet">
    <link href="<?= base_url() ?>/vendors/ion.rangeSlider/css/ion.rangeSlider.css" rel="stylesheet">
    <link href="<?= base_url() ?>/vendors/ion.rangeSlider/css/ion.rangeSlider.skinFlat.css" rel="stylesheet">
    <!-- Select2 -->
