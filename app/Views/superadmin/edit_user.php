            ...
            <div class="x_panel">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade <?= $validation->hasError('Password') == TRUE || $validation->hasError('RepeatPassword') == TRUE || $validation->hasError('inputPassword') == TRUE ? '' : 'show active' ?>" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                        <div class="x_title">
                            <h2>User <small>Change Profile</small></h2>
                        ...
                        <div class="x_content">
                            <form class="" action="/administrator/updateUser/<?= $user['id_user']; ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" disabled="disabled" value="<?= $user['date_created_usr'] ?>" />
                                    </div>
                                </div>
                                <div class="field item form-group">
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control <?= ($validation->hasError('NIP')) ? 'is-invalid' : ''; ?>" name="NIP" data-inputmask="'mask': '999-99-99999'" value="<?= $user['nip_user']; ?>" autofocus />
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control <?= ($validation->hasError('Name')) ? 'is-invalid' : ''; ?>" name="Name" type="text" value="<?= $user['name_user']; ?>" />
                                        <div class="invalid-feedback position-sticky">
                                ...
                                <div class="field item form-group file-upload-wrapper">
                                    ...
                                    <div class="col-sm-2">
                                        <img src="/img/<?= $user['img_user']; ?>" class="img-thumbnail img-preview">
                                    </div>
                                    <div class="col-md-4 col-sm-4 file-upload-wrapper">
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label" for="Image"><?= $user['img_user']; ?></label>
                                            <div class="invalid-feedback position-sticky">
                    ...
                    <div class="tab-pane fade <?= $validation->hasError('Password') == TRUE || $validation->hasError('RepeatPassword') == TRUE || $validation->hasError('inputPassword') == TRUE ? 'show active' : '' ?>" id="password" role="tabpanel" aria-labelledby="password-tab">
                        ...
                        <div class="x_content">
                            <form class="" action="/administrator/changePasswordUser/<?= $user['id_user']; ?>" method="post">
                                <input type="hidden" value="<?= $user['id_user']; ?>" name="id_user">
                                <div class="field item form-group">
