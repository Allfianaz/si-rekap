...
<div class="col-md-12 col-sm-12  ">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td class=" "><?= $lcs['jam_keluar']; ?></td>
                                <td class=" "><?= $lcs['jam_masuk']; ?></td>
                                <td class=" "><?= $lcs['keterangan_izin']; ?></td>
                                </td>
                                <td>
                                    <div class="">
                                        <a href="/user/perizinan/izinKeluar/edit/<?= $lcs['id_perizinan']; ?>" class="btn btn-primary btn-sm fa fa-edit"></a>

                                        <a href="/perizinan/izinKeluar/delete/<?= $lcs['id_perizinan']; ?>" class="btn btn-danger btn-sm fa fa-trash btn-delete" type="submit"></a>
                                    </div>
                                </td>
                            </tr>
                        <?php } ?>
    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            <form class="" action="/perizinan/izinKeluar/save" method="post">
                ...
                <div class="field item form-group">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <input class="form-control time <?= ($validation->hasError('jam_keluar')) ? 'is-invalid' : ''; ?>" type="time" name="jam_keluar" value="<?= old('jam_keluar') ?>" />
                        <div class="invalid-feedback position-sticky">
