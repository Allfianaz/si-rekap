...
<div class="col-md-12 col-sm-12  ">
    <div class="x_panel">
        <div class="x_title">
            <h2><?= $report['pimpinan_meeting']; ?><small><?= $report['tanggal_meeting']; ?><small><?= $report['jam_meeting']; ?></small></small></h2>
        ...
        <div class="x_content">
            <div class="col-md-12">
            <textarea disabled name="materi" id="materi"><?= $report['materi_meeting']; ?></textarea>
            </div>
        </div>
    </div>
</div>
