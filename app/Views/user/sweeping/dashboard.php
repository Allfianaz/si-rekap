...
<div class="col-md-12 col-sm-12  ">
                ...
                <table class="table table-striped jambo_table bulk_action table-bordered text-center">
                    <thead>
                        <tr class="headings">
                            ...
                            <th class="column-title">Sweeping Hours </th>
                            <th class="column-title">Location </th>
                            <th class="column-title">Sweeping Detail</th>
                    ...
                    <tbody>
                        <?php
                        $no = 1;
                        foreach ($sweeping as $swp) {
                        ?>
                            <tr>
                                <td class=" "><?= $no++ ?></td>
                                <td class=" "><?= $swp['tanggal_laporan_swp']; ?></td>
                                <td class=" "><?= $swp['waktu_laporan_swp']; ?></td>
                                <td class=" "><?= $swp['tempat_swp']; ?></td>
                                <td class=" last"><a href="/user/report/sweeping/detail/<?= $swp['id_laporan_swp']; ?>">Detail</a>
                                </td>
                                <td>
                                    <div class="">
                                        <a href="/user/report/sweeping/edit/<?= $swp['id_laporan_swp']; ?>" class="btn btn-primary btn-sm fa fa-edit"></a>
                                        
                                        <a href="/report/sweeping/delete/<?= $swp['id_laporan_swp']; ?>" class="btn btn-danger btn-sm fa fa-trash btn-delete" type="submit"></a>
                                    </div>
                                </td>
                            </tr>
                        <?php } ?>
    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            <form class="" action="/report/sweeping/save" method="post">
